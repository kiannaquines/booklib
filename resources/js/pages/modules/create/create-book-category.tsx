...
const CreateBookCategory = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        setProcessing(true);
        e.preventDefault();
        router.post(route("book-categories.store"), data, {
            preserveScroll: true,
            onSuccess: () => {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
                ...
                <div className="relative h-full flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-sidebar-border p-5">
                    <div className="flex flex-col gap-1">
                        <h2 className="text-lg font-semibold">Create Book Category</h2>
                        <p className="text-sm text-muted-foreground">Create a new book category</p>
                    </div>
